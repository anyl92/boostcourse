...
<body>
    <div id="container">
        ...
        <div class="header fade" id="display_info_id_value" data-id="<c:out value="${displayInfoId }" />">
        ...
        <div class="ct">
            <div class="ct_wrap">
                <div class="top_title">
                    ...
                    <a href="/detail/<c:out value="${displayInfoId }" />" class="btn_back" title="이전 화면으로 이동"> <i class="fn fn-backward1"></i> </a>
	...
	<script type="rv-template" id="display_image">
		<ul class="visual_img">
	...
	<script type="rv-template" id="display_info">
	    <h3 class="in_tit" id="hide_product_id" data-id="{{productId}}">장소</h3>
	    <p class="dsc">
			{{placeName}}
	    </p>
	    <h3 class="in_tit">기간</h3>
	    <p class="dsc">
	        {{openingHours}}
	    </p>
	    <h3 class="in_tit"></h3>
	...
	<script type="rv-template" id="ticket_info">
		<div class="qty" data-id={{productPriceId}}>
		    ...
		    <div class="qty_info_icon"> 
		    	<strong class="product_amount"> <span data-type={{priceId}}>{{priceTypeName}}</span> </strong> 
    ...
    <script type="module" src="/js/reservation/reserve.js"></script>
