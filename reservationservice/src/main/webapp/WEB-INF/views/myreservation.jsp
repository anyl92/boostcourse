...
<body>
	<div id="container">
		<div class="header" id="reservation_info_email_value" data-email="<c:out value="${email }" />">
									...
									<div class="card_body">
										...
										<div class="middle">
											<div class="card_detail">
												...
												<div class="booking_cancel" data-comment="{{displayInfoId}}">
													<a href="/reviewWrite/2"> <button class="btn"><span>예매자 리뷰 남기기</span></button></a>
												</div>
											</div>
										</div>
										<div class="right"></div>
	...
	<div class="popup_booking_wrapper" style="display:none;">
		...
		<div class="popup_booking refund">
			<h1 class="pop_tit">
				<span id="popup_description">${productDescription}</span>
				<small class="sm" id="popup_date">${reservationDate}</small>
			</h1>
			...
			<div class="pop_bottom_btnarea">
				<div class="btn_gray">
					<a href="#" class="btn_bottom" id="cancel_no"><span>아니오</span></a>
				</div>
				<div class="btn_green">
					<a href="#" class="btn_bottom" id="cancel_ok"><span>예</span></a>
				</div>
			</div>
			<!-- 닫기 -->
	...
	<script type="rv-template" id="cancel_confirm_popup">
		
	</script>

	<script type="rv-template" id="confirm_cards">
		<article class="card_item" data-id="{{reservationInfoId}}">
				...
				<div class="card_body">
					...
					<div class="middle">
						<div class="card_detail">
							...
							<!-- [D] 예약 신청중, 예약 확정 만 취소가능, 취소 버튼 클릭 시 취소 팝업 활성화 -->
							<div class="booking_cancel">
								<button class="btn" id="cancel_button" 
								data-id="{{reservationInfoId}}"
	...
	<script type="rv-template" id="reservation_count">
		<li class="item">
			<!--[D] 선택 후 .on 추가 link_summary_board -->
			<a href="#" class="link_summary_board on"> <i class="spr_book2 ico_book2"></i> <em class="tit">전체</em> <span class="figure">{{total}}</span> </a>
		</li>
		<li class="item">
			<a href="#" class="link_summary_board"> <i class="spr_book2 ico_book_ss"></i> <em class="tit">이용예정</em> <span class="figure">{{confirmed}}</span> </a>
		</li>
		<li class="item">
			<a href="#" class="link_summary_board"> <i class="spr_book2 ico_check"></i> <em class="tit">이용완료</em> <span class="figure">{{used}}</span> </a>
		</li>
		<li class="item">
			<a href="#" class="link_summary_board"> <i class="spr_book2 ico_back"></i> <em class="tit">취소·환불</em> <span class="figure">{{usedCancel}}</span> </a>
		</li>
	</script>

	<script type="module" src="/js/user/myreservation.js"></script>
    <script type="module" src="/js/utils/addCommaInNumber.js"></script>
	<script src="/js/utils/handlebars.js"></script>
</body>
