...
<body>
	<div id="container" id="display_info_id_value" data-id="<c:out value="${displayInfoId }" />" >
				...
				<div class="write_act">
					...
					<div class="review_rating rating_point">
						<div class="rating">
							...
							<span class="star_rank gray_star" name="score">0</span>
						</div>
					</div>
				</div>
				<!-- //리뷰 별점 -->
				...
				<div class="review_write_footer_wrap">
					<div class="review_write_footer">
						<label class="btn_upload" for="reviewImageFileOpenInput">
							...
							<input type="file" name="file" class="hidden_input" id="reviewImageFileOpenInput" accept="image/png, image/jpg" multiple>
	...
	<script src="/js/reservation/reviewWrite.js"></script>
</body>
</html>