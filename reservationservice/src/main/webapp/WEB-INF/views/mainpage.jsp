...
<body>
        ...
        <div class="event">
            ...
            <div class="section_event_lst">
                ...
                <div class="wrap_event_box">
                    ...
                    <div class="more" id="show_more_button">
    ...
    <script type="rv-template" id="itemList">
        <li class="item">
            <a href="/detail/{id}" name="displayInfoId" class="item_book">
                <div class="item_preview">
                    <img alt="{description}" class="img_thumb" src="/img/{ImageUrl}">
	...
	<script src="/js/mainpage/category.js"></script>
