...
<body>
            ...
            <div><c:out id="display_info_id_value" data-id="${displayInfoId }" />
                ...
                <div class="section_info_tab">
                    ...
                    <ul class="info_tab_lst">
                        <li class="item ">
                            <a class="anchor active"> <span class="_detail">상세정보</span> </a>
                        </li>
                        <li class="item ">
                            <a class="anchor"> <span class="_path">오시는길</span> </a>
                        </li>
                    </ul>
                    <!-- [D] 상세정보 외 다른 탭 선택 시 detail_area_wrap에 hide 추가 -->
                    <div class="detail_area_wrap" id="info_tab_detail">
                        ...
                        <div class="detail_info">
                                ...
                                <ul class="detail_info_group">
                                    <li class="detail_info_lst">
                                        ...
                                        <p class="in_dsc" id="detail-content">
                                        </p>
                                    </li>
                    ...
                    <div class="detail_location hide" id="info_tab_map">
	...
	<script type="rv-template" id="display_image_List">
		<li class="item" style="width: 414px;"> 
            ...
            <div class="visual_txt" style="display:flex;">
                <div class="visual_txt_inn" style="height:100%; padding:44% 0;">
	...
	<script type="rv-template" id="display_content">
	...
	<script type="rv-template" id="display_map">
		<div class="box_store_info no_topline">
		    <a href="{{homePage}}" class="store_location" title="지도웹으로 연결">
		        ...
		        <div class="lst_store_info_wrap">
		            <ul class="lst_store_info">
		                <li class="item"> <span class="item_lt"> <i class="fn fn-call2"></i> 
							...
							<a href="tel:{{telephone}}" class="store_tel">{{telephone}}</a></span> 
						</li>
		            </ul>
		        </div>
		    </div>
