...
public class Comment {
	...
	public String getStarOfUserId() {
		return starOfUserId;
	}
	public void setStarOfUserId(String starOfUserId) {
		this.starOfUserId = starOfUserId;
	}
	...
	public String toString() {
		return "Comment [comment=" + comment + ", commentId=" + commentId + ", commentImages=" + commentImages
				...
				+ ", reservationDate=" + reservationDate + ", starOfUserId=" + starOfUserId + ", reservationEmail="
